...
public class Map {
	 ...
	 *            path nodes.
	 */
	public void drawMap(Graphics g, LinkedList<Node> path)
	{
		for (int y = 0; y < height; y++)
		{
			for (int x = 0; x < width; x++)
	 ...
	 *            path nodes.
	 */
	public void printMap(LinkedList<Node> path)
	{
	 ...
	 */
	public final LinkedList<Node> findPath(int startX, int startY, int goalX, int goalY)
	{
		...
		while (true)
		{
			...
			LinkedList<Node> adjacentNodes = getAdjacent(current, closedList);
	 ...
	 *         start.
	 */
	private LinkedList<Node> calcPath(Node start, Node goal)
	{
	 ...
	 */
	private Node lowestFInList(LinkedList<Node> list)
	{
	 ...
	 */
	private LinkedList<Node> getAdjacent(Node node, LinkedList<Node> closedList)
	{
